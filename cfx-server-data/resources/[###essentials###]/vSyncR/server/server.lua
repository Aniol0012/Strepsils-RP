...
RegisterCommand('parartiempo', function(source, args)
    if source ~= 0 then
...
RegisterCommand('purga', function(source)
    if source == 0 then
...
RegisterCommand('mañana', function(source)
    if source == 0 then
...
RegisterCommand('mediodia', function(source)
    if source == 0 then
        print(_U('time_console'))
        return
    end
...
RegisterCommand('noche', function(source)
    if source == 0 then
        print(_U('time_console'))
        return
    end
...
RegisterCommand('tiempo', function(source, args, rawCommand)
    if source == 0 then
...
print("vSync Modificado por Aniol0012 ha cargado!")