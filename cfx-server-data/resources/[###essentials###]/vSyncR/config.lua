...
Config.AdminByID        = true -- Set to true if you want to set the access to the commands only to certain people (otherwise the permissions will be to ace access)
...
Config.Admins = { -- Only if Config.AdminByID is set to true  -- EXAMPLE : steam:110000145959807 or license:1234975140128921327
    'steam:110000117a1e4c9',  -- Aniol 
	'steam:1100001172b03f4',  -- Cogollo 
}
