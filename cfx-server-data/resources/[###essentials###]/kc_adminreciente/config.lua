...
Config.WarnPerma = 10 -- Contador de avisos para que te permabanee.
Config.WarnWeek = 5 -- Contador de avisos para que te vanee 3 dias. server.lua/L931
Config.WarnDays = 3 -- Contador de avisos para que te vanee 1 dia. server.lua/L936

Config.Jails = {
    {x = -439.6, y = 5987.12, z = 31.72},
    {x = -439.27, y = 5992.4, z = 31.72}
}
Config.ExitFromJail = {["x"] = -436.82, ["y"] = 6019.91, ["z"] = 31.49}
Config.MaxJailDistance = 20
Config.JailWarns = 2
Config.JailWarnsMinutes = 10

Config.CheckJobType = "false" -- esx/sql/false
Config.DefaultJob = {"unemployed", 0}

Config.SecurityCode = "674521" -- Codigo para salir de la prision
...
Permissions.UnJail          = {Groups.Mod, Groups.Admin, Groups.SuperAdmin, Groups.Server}
...
Lang.Reparar                    = "El vehículo ha sido reparado correctamente"
Lang.Tpm                        = "Te has teletransportado correctamente. [Acuerdate que esto solo funciona para uno mismo, para los otros usa el bring, goto o return]."
...
Lang.InsufficientPrivileges     = "¡Permisos Insuficientes!"
