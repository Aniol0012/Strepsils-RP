...
function Client() {
	...
	var tpm_button = document.createElement("button");
	var reparar_button = document.createElement("button");
    ...
    revive_button.innerText = "Revivir";
	...
	tpm_button.id = "tpm_button";
    tpm_button.className = "btn btn-secondary";
    tpm_button.innerText = "GODMODE";
    tpm_button.onclick = function () {
        var player_id = document.getElementsByClassName("player selected")[0].id.split("_")[1];

        $.post("http://kc_admin/tpm", JSON.stringify({"id" : player_id}))
    }
	
	reparar_button.id = "reparar_button";
    reparar_button.className = "btn btn-secondary";
    reparar_button.innerText = "Reparar";
    reparar_button.onclick = function () {
        var player_id = document.getElementsByClassName("player selected")[0].id.split("_")[1];

        $.post("http://kc_admin/reparar", JSON.stringify({"id" : player_id}))
    }
	...
	container.appendChild(tpm_button);
	container.appendChild(reparar_button);
...
function ServerF() {
    ...
    var rows = ["Usuario", "Razón", "Sancionador", "Fecha de expiración", "Fecha de aplicación", ""];
