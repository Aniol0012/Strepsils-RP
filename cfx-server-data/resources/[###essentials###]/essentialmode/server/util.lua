...
settings.defaultSettings = {
	...
	['startingCash'] = GetConvar('es_startingCash', '500'), -- Aquí puedes cambiar el dinero inicial en mano
	['startingBank'] = GetConvar('es_startingBank', '8000'), -- Aquí puedes cambiar el dinero inicial en el banco
