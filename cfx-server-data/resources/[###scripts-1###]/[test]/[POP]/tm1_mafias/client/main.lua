	...
	while true do
		...
		if forceStop == false then
			if ISMENUACTIVE == true then
				drawTxt(group.name,1, 1, 0.94, 0.19, 0.65,255,0,0,255)
				drawTxt(group.money.." DOLARES",2, 1,  0.94, 0.23, 0.45,0,255,0,255)
				drawTxt(rankLabel[group.rank],2, 1, 0.94, 0.25, 0.45,0,255,239,255)
				drawTxt(grouplabel[group.aprove],2, 1, 0.94, 0.27, 0.45,0,255,239,255)
			end
		else
			break
		end
