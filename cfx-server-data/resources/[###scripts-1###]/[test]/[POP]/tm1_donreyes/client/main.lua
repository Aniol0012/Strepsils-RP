...
local jobFase = 0
local NPCs = {
	{x = -453.04, y = 6197.56, z = 29.56,hash = -1922568579,rot = 0.0, top = "Er ~r~Davisico", id = 'reyes',anim = 'WORLD_HUMAN_SMOKING'},
	{x = -454.92, y = 6198.56, z = 29.56,hash = -1731772337,rot = -90.0, top = "Sr ~r~Omega", id = 'rockefeller',anim = 'world_human_leaning'},
	{x = -452.64, y = 6200.52, z = 29.56,hash = 919005580,rot = 145.0, top = "Cp ~r~Venom", id = 'marcos',anim = 'WORLD_HUMAN_PARTYING'},
	{x = -455.24, y = 6205.08, z = 29.56,hash = -1040164288,rot = -180.0, top = "Rct ~r~Paulaner", id = 'carlos',anim = 'WORLD_HUMAN_PARTYING'},
	{x = -455.08, y = 6203.96, z = 29.56,hash = -277325206,rot = 90.0, top = "Rct ~r~Meliodas", id = 'asikause',anim = 'mp_player_int_grab_crotch'},
	{x = -456.16, y = 6207.16, z = 29.56,hash = 874722259,rot = -90.0, top = "Rct ~r~Albert Donaire", id = 'nico',anim = 'WORLD_HUMAN_SMOKING'}
}
local Doors = {
