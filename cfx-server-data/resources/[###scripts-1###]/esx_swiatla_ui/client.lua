...
AddEventHandler("esx_swiatla:otworz", function()
	...
	if IsPedInVehicle(ped, car, false) then
		...
		ESX.ShowAdvancedNotification('Mecánico', '', "~y~Debes estar sentado en un vehículo para cambiar el color de las luces", pic, 1)
	end
end)
...
RegisterNUICallback('save', function(data, cb)
	...
	ESX.TriggerServerCallback("esx_swiatla:zapisz_swiatla", function(isPurchasable)
		if isPurchasable then
			ESX.ShowAdvancedNotification('Mecánico', '', "~g~Se han instalado las luces", pic, 1)
		else
			ESX.ShowAdvancedNotification('Mecánico', '', "~r~Error", pic, 1)
		end
