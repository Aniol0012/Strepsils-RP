...
Config.DisableKeys = {0, 22, 23, 24, 29, 30, 31, 37, 44, 56, 82, 140, 170, 288, 311, 323}
...
Config.Strings = {
	...
	CancelFuelingJerryCan = "Pulsa ~g~E ~w~para parar de repostar",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Pulsa ~g~E ~w~ para rellenar el bidón por ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero para repostar",
	JerryCanFull = "El bidón esta lleno",
	TotalCost = "Precio",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Pulsa ~g~E ~w~para comprar un bidón"
