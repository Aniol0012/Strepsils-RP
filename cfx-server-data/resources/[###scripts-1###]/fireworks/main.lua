...
RegisterCommand("sf", function()
	TriggerEvent('strepsils_petardo')
end)


RegisterNetEvent('strepsils_petardo')
AddEventHandler('strepsils_petardo', function()
...
-- Particulas default: scr_indep_firework_trailburst, scr_indep_fireworks