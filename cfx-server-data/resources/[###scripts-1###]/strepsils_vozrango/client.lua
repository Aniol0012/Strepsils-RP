...
-- colors
local r,g,b,a = 0,255,0,255 -- rgba color, Rojo (255,1,10,255)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(0, Keys['X']) and IsControlPressed(0, Keys['LEFTSHIFT']) then
        ...
        if IsControlPressed(0, Keys['X']) and IsControlPressed(0, Keys['LEFTSHIFT']) then
            if voice.current == 0 then
