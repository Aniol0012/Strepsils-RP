...
RegisterNetEvent('strepsils_trabajos')
AddEventHandler('strepsils_trabajos', function()
	ToggleScoreBoard()
	Citizen.Wait(200)
end)
...
RegisterNetEvent('strepsils_trabajos_cerrar')
AddEventHandler('strepsils_trabajos_cerrar', function()
	CerrarScoreBoard()
	Citizen.Wait(200)
end)
