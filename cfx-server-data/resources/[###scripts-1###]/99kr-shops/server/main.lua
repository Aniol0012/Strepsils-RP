...
AddEventHandler('99kr-shops:Cashier', function(price, basket, account)
    ...
    pNotify('Has comprado productos por <span style="color: green">' .. price .. '€</span>', 'success', 3000) --pNotify('You bought products for <span style="color: green">$' .. price .. '</span>', 'success', 3000)
