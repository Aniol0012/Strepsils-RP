...
Citizen.CreateThread(function()
  while true do
    ...
    if Config.MenuKeybindEnabled then if IsControlPressed(0, Config.Abrir) and not IsDead then OpenEmoteMenu() end end
    if Config.EnableXtoCancel then if IsControlPressed(0, Config.Cancelar) then EmoteCancel() end end
    Citizen.Wait(1)
  end
end)
...
function OnEmotePlay(EmoteName)
  ...
  if not Config.PermitirCoche and InVehicle == 1 then
    return
  end
