...
TriggerEvent('es:addCommand', 'suelo', function()
end, { help = ('Tumbarse en el suelo') })

TriggerEvent('es:addCommand', 'k', function(source, args, user)
	TriggerClientEvent('strepsils_arrestado', source, {})
end, {help = "Poner las manos sobre la cabeza para dejar que te arresten"})
