...
Config.RespawnPoint = { coords = vector3(-245.62, 6329.27, 32.43), heading = 224.58 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(-255.63, 6332.1, 32.43),
			sprite = 80,
			scale  = 1.0,
			color  = 1
		},
		...
		AmbulanceActions = {
			vector3(-248.97, 6301.81, 31.44)
		},

		Pharmacies = {
			vector3(-245.58, 6306.09, 31.46)
		},

		Vehicles = {
			{
				Spawner = vector3(-221.52, 6326.4, 31.46),
				InsideShop = vector3(342.181, -558.66, 28.7),
				Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(-223.01, 6318.04, 31.35), heading = 31.06, radius = 4.0 },
