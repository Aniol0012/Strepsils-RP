...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		title    = '<span style="color:red;">Ambulancia<span style="color:white;">',
		align    = 'right',
		elements = {
			...
			{label = '<span style="color:red;">🚑 EMS no disponible<span style="color:white;">', value = 'ems_ferme'},
			{label = '<span style="color:darkorchid;">🏥 Marcar en el GPS el Hospital<span style="color:white;">', value = 'gpsems'}
		}
	}, function(data, menu)
		...
		elseif data.current.value == 'gpsems' then
				SetNewWaypoint(-240.13, 6334.60, 32.43)

				PlaySoundFrontend( -1, "CHECKPOINT_PERFECT", "HUD_MINI_GAME_SOUNDSET", 3)

				ESX.ShowAdvancedNotification('EMS', '~y~', '~g~Has marcado el hospital', 'CHAR_CALL911', 1)

				Citizen.Wait(1)

		elseif data.current.value == 'citizen_interaction' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				title    = '<span style="color:red;">❤️EMS<span style="color:white;">',
				align    = 'right',
				elements = {
...
function OpenVehicleSpawnerMenu(hospital, partNum)
	...
	local elements = {
		...
		{label = '<span style="color:green;">Sacar Ambulancia<span style="color:white;">', value = 'emscar1'}
	}
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'emscar1' then
			TriggerEvent('esx:spawnVehicle', "ambulance")
		end
