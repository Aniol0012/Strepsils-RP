...
Config.CarGarageSprite = 557
Config.CarGarageDisplay = 4
Config.CarGarageScale = 0.65
Config.CarGarageColour = 1
Config.CarGarageName = "Garaje del Hospital [EMS]"
...
Config.ambulanceCarMarkerColor = { r = 255, g = 0, b = 0, a = 100 } 			-- rgba color of the marker
Config.ambulanceCarMarkerScale = { x = 4.5, y = 4.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "Pulsa ~r~[E] ~s~para abrir el garaje de EMS"			-- set your desired text here
...
Config.ExtraDraw3DText = "Press ~r~[E]~s~ for ~y~ambulance Extra Menu~s~"		-- set your desired text here

-- ambulance Cars:
Config.ambulanceVehicles = {	
		{ model = 'ambulance', label = 'Ambulancia'},
		{ model = 'ems1', label = 'EMS1'},				
}
...
Config.VehicleParked = "Has guardado el vehículo"
Config.NoVehicleNearby = "¡No hay ningún vehículo!"
Config.CarOutFromPolGar = "Has sacado un ~b~vehículo~s~ del ~y~garaje del hospital~s~"
...
Config.VehicleLoadText = "Espera a que cargue el vehículo"			-- text on screen when vehicle model is being loaded
