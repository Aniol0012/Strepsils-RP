...
Config.MinimumDistance            = 3000 -- Distancia mínima para recojer los NPC para el trabajo de taxi. Cuanto mas alto el numero mas lejana será la destinación.
...
Config.Zones = {
	...
	TaxiActions = {
		Pos   = {x = -370.83, y = 6113.87, z = 31.69},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	},
	...
	Cloakroom = {
		Pos     = {x = -366.71, y = 6106.83, z = 31.69},
		Size    = {x = 1.0, y = 1.0, z = 1.0},
