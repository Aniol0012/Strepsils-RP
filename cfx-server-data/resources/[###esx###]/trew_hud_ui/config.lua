...
Config.ui = {
	...
	showMinimap			= true, -- En true se ve el minimapa, y en false no. Esto con la strepsils_hud se puede modificar mejor. No tocar esto preferiblemente.
