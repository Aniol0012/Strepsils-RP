...
AddEventHandler('esx_firejob:revive', function()
  ...
  Citizen.CreateThread(function()
	...
	ESX.ShowNotification(_U('revive_fine_paid', Config.ReviveReward, GetPlayerName(closestPlayer)))
