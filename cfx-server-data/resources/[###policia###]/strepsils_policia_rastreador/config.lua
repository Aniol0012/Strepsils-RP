Config = {}
Config.Locale = 'en' --Z Supported languages (English: en, Slovene: sl, French: fr)
Config.openKey = 20 -- Button to open up the menu (see: https://docs.fivem.net/docs/game-references/controls/)
