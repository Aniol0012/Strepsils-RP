...
globalConf = {
	...
	["CLIENT"] = {
		...
		lockTimer = 0.5,					-- Timer between two changes (open/close - in seconds)
	}
}
...
randomMsg =
{
	"Encontraste las llaves en la guantera",
	"Encontraste las llaves en la riñonera",
	"Encontraste las llaves en el bolsillo",
}
