...
CinematicCamMaxHeight = 0.3 -- [[The height of the rects. Keep below 1 and keep as a float however I recommend you keep it as it is as this is the best height I could find]]
...
RegisterNetEvent('strepsils_cam')
AddEventHandler('strepsils_cam', function()
	ToggleCam()
end)

RegisterNetEvent('strepsils_cerrar_cam')
AddEventHandler('strepsils_cerrar_cam', function()
