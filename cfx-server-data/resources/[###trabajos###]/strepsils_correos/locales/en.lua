Locales['en'] = {
	...
	--Garage
	['sort_vehicle']			= 'Pulsa ~INPUT_PICKUP~ to retrieve the vehicle',
	['return_vehicle']			= 'Pulsa ~INPUT_PICKUP~ to return the vehicle',
	...
	['pickup']					= 'Pulsa ~INPUT_PICKUP~ to deliver',
	...
	--Distribution
	['open_distribution']		= 'Pulsa ~INPUT_PICKUP~ To recover mail and parcels',
