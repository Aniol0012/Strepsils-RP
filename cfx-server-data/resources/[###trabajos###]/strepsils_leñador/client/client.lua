...
function AbrirMenu()
	...
	ESX.UI.Menu.Open(
		...
		{
			title  = 'Quieres que te compre toda la madera?',
			align    = 'bottom-right',
			elements = elements
		},
		function(data, menu)	
...
local blips = {
    {title="Leñador", colour=7, id=85, x = 345.94, y = 6496.72, z = 28.92-1},
    {title="Venta de Madera", colour=7, id=85, x = -552.38,y = 5327.27,z = 73.6},
}
