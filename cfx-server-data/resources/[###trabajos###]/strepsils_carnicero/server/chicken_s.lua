...
TriggerEvent('notification', 'You can only hold ' ..maxZywych.. ' chickens at once!!', 2)
Wait(2500)
end
end)
...
if opcja == 1 then
	...
	TriggerEvent('notification', 'You can only hold ' ..MaxMartweKurczaki.. ' Dead chickens at once!', 2)
	Wait(2500)
	end
end
...
if opcja == 3 then
	...
	TriggerEvent('notification', 'You Sold $' ..GotowkaSprzedaz.. ' worth of packaged chicken!', 1)
	Wait(1500)
	end
end
